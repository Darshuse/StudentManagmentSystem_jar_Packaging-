...
import com.boubyan.me.Student_Managment_System.config.security.jwt.JwtUtils;
...
import com.boubyan.me.Student_Managment_System.payload.request.LoginRequest;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		user.setAge(20);
		user.setFamilyName("ebada");
        user.setStudentCourses(null);
